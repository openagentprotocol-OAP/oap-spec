...
L0 is base conformance with the discovery, identity, and invocation primitives. L1 adds the accountability layer including Receipts and the per Principal chain. L2 adds the commercial layer including the Wallet abstraction and Settlement Receipts. L3 adds the policy layer including the four layer policy stack and the Decision Records. L4 adds the privileged mode obligations and the industry profile conformance for the regulated domains the operator declares.
